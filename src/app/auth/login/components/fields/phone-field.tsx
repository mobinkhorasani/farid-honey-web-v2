// ─────────────────────────────────────────────────────────────────────────────
// file: components/auth/login/fields/PhoneField.tsx
// ─────────────────────────────────────────────────────────────────────────────
'use client'
...
export const PhoneField = ({ id = 'phone', label = 'شماره موبایل', hint, error, registration }: PhoneFieldProps) => {
  ...
  return (
    <div className="space-y-1.5 sm:space-y-2">
      ...
      {/* Wrapper: ارتفاع ثابت برای ثابت ماندن آیکن */}
      <div className="relative h-12 md:h-14">
        {/* آیکن سمت راست (کاملاً ثابت و وسط عمودی) */}
