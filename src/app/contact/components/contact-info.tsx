    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
      <div className="group bg-white rounded-xl border border-[#EFEFEF] hover:border-amber-200 transition-shadow shadow-sm hover:shadow-md p-6 md:p-7">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-base md:text-lg font-semibold text-[#1A1A1A] mb-2">
              آدرس فروشگاه اصلی
            </h3>
            <address className="not-italic text-[#6B7280] leading-relaxed mb-3">
              {addressDisplay}
            </address>
            <div className="flex gap-2">
              ...
              <Button
                asChild
                size="sm"
                className="rounded-lg bg-[#E9B159] hover:bg-[#E9B159]/90 text-white"
              >
                <a
      ...
      <div className="group bg-white rounded-xl border border-[#EFEFEF] hover:border-amber-200 transition-shadow shadow-sm hover:shadow-md p-6 md:p-7">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-base md:text-lg font-semibold text-[#1A1A1A] mb-3">
              شماره تماس
            </h3>
