...
export const OrdersTable = ({ orders, isLoading, token }: OrdersTableProps) => {
  ...
  if (isLoading) {
    return (
      <div
        className="bg-white rounded-3xl border-0 shadow-lg p-6 space-y-4"
        dir="rtl"
      >
        {[...Array(5)].map((_, i) => (
  ...
  if (!orders || orders.length === 0) {
    return (
      <div
        className="text-center py-12 bg-white rounded-3xl border-0 shadow-lg"
        dir="rtl"
      >
  ...
  return (
    <div
      className="bg-white rounded-3xl border-0 shadow-lg overflow-hidden"
      dir="rtl"
    >
