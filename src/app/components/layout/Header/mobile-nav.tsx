...
import { Menu, X, PhoneCall, Clock, Instagram, MessageCircle, Send, ShoppingCart, User } from 'lucide-react'
        ...
        <>
          ...
          >
            <div className="flex h-full flex-col p-6">
              ...
              {/* اکشن‌های آیکنی — بدون یوزر و سبد خرید */}
              {/* <div className="mb-6 flex items-center gap-3">
                {actionNav.map(({ href, title, icon: Icon }) => {
                  // ❌ شرط: اگه یوزر یا سبد خرید بود، اصلاً رندر نکن
                  if (title === 'سبد خرید' || title === 'پروفایل') return null
